...
RUN chown -R www-data:www-data /var/www/html/STF_UDIN \
    ...
    && chmod -R 775 /var/www/html/STF_UDIN/storage /var/www/html/STF_UDIN/bootstrap/cache \
    && chown -R www-data:www-data /var/www/html/STF_UDIN/storage /var/www/html/STF_UDIN/bootstrap/cache
...
RUN sed -i 's|DocumentRoot /var/www/html|DocumentRoot /var/www/html/STF_UDIN/public|' /etc/apache2/sites-available/000-default.conf \
    && sed -i 's|<Directory /var/www/>|<Directory /var/www/html/STF_UDIN/public/>|' /etc/apache2/apache2.conf \
